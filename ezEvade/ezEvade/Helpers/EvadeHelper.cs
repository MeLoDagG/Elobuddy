...
namespace ezEvade.Helpers
{
    class EvadeHelper
    {
        ...
        public static PositionInfo GetBestPosition()
        {
            ...
            extraDelayBuffer += (int)(EzEvade.AvgCalculationTime);
        ...
        public static PositionInfo GetBestPositionTargetedDash(EvadeSpellData spell)
        {
            ...
            if (spell.EvadeType == EvadeType.Dash)
            {
                ...
                if (first != null && EzEvade.LastPosInfo != null && first.IsDangerousPos == false
                    && EzEvade.LastPosInfo.PosDangerLevel > first.PosDangerLevel)
                {
                    return first;
                }
            }
