...
namespace ezEvade
{
    public class EzEvade
    {
        public const string LastUpdate = "2/3/2016";
        ...
        protected static SpellSlot LastSpellCast;
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                miscMenu.Add("HigherPrecision", new DynamicCheckBox(ConfigDataType.Data, "HigherPrecision", "Enhanced Dodge Precision", true).CheckBox);
              ...
              //  limiterMenu.Add("EnableEvadeDistance", new DynamicCheckBox(ConfigDataType.Data, "EnableEvadeDistance", "Extended Evade", false).CheckBox);
                limiterMenu.Add("TickLimiter", new DynamicSlider(ConfigDataType.Data, "TickLimiter", "Tick Limiter", 0, 0, 500).Slider);
              ...
              //  bufferMenu.Add("ExtraEvadeDistance", new DynamicSlider(ConfigDataType.Data, "ExtraEvadeDistance", "Extra Evade Distance", 100, 0, 300).Slider);
                ...
                Chat.Print(text: "<font color='#23ADDB'>ezEvade Loading....</font><font color='#E81A0C'>Enjoy your game :-))");
