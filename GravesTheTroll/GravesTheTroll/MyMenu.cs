...
{
    internal static class GravesTheTrollMeNu
    {
        ...
        private static void MyGravesTheTrollPage()
        {
            _myMenu = MainMenu.AddMenu("Graves The Troll", "main");
            _myMenu.AddLabel(" Graves The Troll " + Program.Version);
        ...
        private static void ComboMenuPage()
        {
            ...
            ComboMenu.AddLabel("Use E only after AA for all logic Reason = Reloaded");
            ComboMenu.AddLabel("Side its side Cursor is cursors And smartQ its restricted and use only if range 1 enemy ");
            ComboMenu.AddSeparator();
            ComboMenu.Add("useEcombo", new ComboBox(" ", 0, "Side", "Cursor", "SmartQ"));
            ComboMenu.AddSeparator();
            ComboMenu.AddLabel("----------------------------------------------------");
        ...
        private static void HarassMeNuPage()
        {
           ...
           HarassMeNu.Add("killsteal.R",
                new CheckBox("Use R", false));
        }
        ...
        private static void ActivatorPage()
        {
         ...
         Activator.Add("Blind",
            ...
            Activator.Add("QssDelay", new Slider("QssDelay", 100, 0, 500));
       ...
       Activator.Add("bilgewater",
        ...
        private static void MiscMeNuPage()
        {
            ...
            MiscMeNu.AddGroupLabel("Anti Gap Closer");
        ...
        {
            return ComboMenu["useEc"].Cast<CheckBox>().CurrentValue;
        }
       ...
       public static bool LaneQ()
        ...
        public static float LaneQcount()
        {
            return FarmMeNu["LaneQcount"].Cast<Slider>().CurrentValue;
        }
